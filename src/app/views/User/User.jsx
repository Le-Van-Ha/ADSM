...
import { deleteItem, searchByDto, getUserOrgById, getAllInfoByUserLogin,getItemById } from "./UserService";
...
class User extends Component {
  ...
  render() {
    ...
    let columns = [
      ...
      { title: t("administrative_unit.title"), field: "adminUnit.name", align: "left", width: "150" },
      { title: t("user.role.title"), field: "user.roles[0].name", align: "left", width: "100" },
      { title: t("user.region"), field: "region", align: "left", width: "100" },
    ];
    return (
