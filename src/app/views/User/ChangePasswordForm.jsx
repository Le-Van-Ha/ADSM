...
export default function ChangePasswordForm(props) {
    ...
    const validationSchema = Yup.object({
        ...
        password: Yup.string().required('Mật khẩu không được để trống').min(6, 'Mật khẩu phải lớn hơn 6 kí tự'),
        confirmPassword: Yup.string().required('Nhập lại mật khẩu mới')
        .oneOf([Yup.ref('password'), null], 'Không trùng với mật khẩu đã nhập trước đó')
    });
