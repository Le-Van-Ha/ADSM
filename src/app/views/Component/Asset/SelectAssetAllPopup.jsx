import { Grid, InputAdornment, Input, Button, Checkbox, TablePagination, Dialog, DialogActions } from "@material-ui/core";
...
class SelectAssetAllPopop extends React.Component {
    ...
    componentWillMount() {
        let { assetVouchers, handoverDepartment, managementDepartmentId } = this.props;
    ...
    render() {
        ...
        let { keyword, assetVouchers } = this.state;
        let columns = [
            {
